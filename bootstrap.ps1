...
then symlinks the skills into your tools. Re-running is also how you update:
it re-downloads the latest and relinks. Install and update are the same command.
